...
public class Inflector
{
    ...
    static
    {
        ...
        plural("(bu)s$", "$1es");
        plural("(buffal|tomat|her)o$", "$1oes");
        plural("([ti])um$", "$1a");
        plural("sis$", "ses");
...
class RuleAndReplacement
{
    ...
    {
        //单数转复数
        System.out.println(Inflector.pluralize("woman"));
        System.out.println(Inflector.pluralize("box"));
        System.out.println(Inflector.pluralize("tomato"));
        System.out.println(Inflector.pluralize("shelf"));
        //复数转单数
        System.out.println(Inflector.singularize("women"));
        System.out.println(Inflector.singularize(""));
    }
}
